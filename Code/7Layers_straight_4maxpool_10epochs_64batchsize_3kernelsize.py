...
print(device)
#------------------------------------------------------------------------------------
transforms = transforms.Compose([transforms.Resize((256,256)), transforms.CenterCrop(224), transforms.ToTensor(),transforms.Normalize(mean=[0.5, 0.5, 0.5],std=[0.5, 0.5, 0.5])])
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.layer7 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool2d(2))
        self.fc = nn.Linear(17 * 17 * 32, 1000)
